...
export class StockReportService {
  ...
  async getAll(companyId: string, criteria: Criteria): Promise<StockReport[]> {
    this.logger.info({ message: `Getting all stock reports`, companyId, criteria });
    return this.stockHistoryRepository.getProductsInDateRangeReport(companyId, criteria);
  }
}